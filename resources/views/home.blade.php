...
<body>
  ...
  <header style="background-image: url('{{ asset('asset/images/header.png') }}') " data-aos="fade-up">
    ...
    <p>Nail Fashion</p>
    <p class="description">
      Step into glam heaven and explore the chicest nail styles around! Get pampered like a queen with the prettiest
      mani-pedi services in town — because you totally deserve it.
    </p>
  </header>

  <section>
    <h2 class="section-title" data-aos="fade-up">Creative Nail Art Studio <br /> WITH MASTERLY PERFORMANCE! </h2>
    <p style="text-align: center; max-width: 600px; margin: auto;" data-aos="fade-up">
      With Expert Touch and Stunning Results! Unleash your style with stunning nail designs crafted by skilled artists.
      From minimalist chic to bold and intricate — we turn your nails into wearable art.
    </p>
  ...
  <section class="branch-locations">
    ...
    <div class="location-row">
      <div class="location-card" style="background-image: url('{{ asset('asset/images/Morningmate.png') }}');" data-aos="fade-up"
        data-aos-delay="100">
        <div class="overlay">
  ...
  <section>
    ...
    <p style="text-align: center; max-width: 600px; margin: auto;" data-aos="fade-up">
      We believe beauty should be as clean as it is captivating. Our nail art is crafted using only natural, high-quality
      products — safe, luxurious, and absolutely stunning
    </p>
